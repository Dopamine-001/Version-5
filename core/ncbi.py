...
def get_ncbi_gene_info(protein_name):
    """
    Searches NCBI Entrez for a matching human gene and returns:
    Gene ID, chromosome, map location, summary, and aliases.
    """
