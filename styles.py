...
.hero{padding:1rem 0 1.1rem;margin-bottom:1rem;}.kicker{font:700 .68rem 'Space Mono',monospace;letter-spacing:.14em;text-transform:uppercase;color:var(--cyan);}.hero-title{font-size:clamp(2.2rem,5vw,4rem);font-weight:700;line-height:1;margin:.35rem 0;}.hero-copy{color:var(--muted);max-width:900px;font-size:1rem;line-height:1.6;}
